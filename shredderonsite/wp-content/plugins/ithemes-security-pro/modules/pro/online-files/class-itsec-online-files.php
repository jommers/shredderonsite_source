...
class ITSEC_Online_Files {
	 ...
	 *
	 * Retreives all file hashes for available plugins from the appropriate repo
	 *
	 * @since  1.14.0
	 *
	 * @access private
	...
	private function get_plugin_hashes() {
		...
		foreach ( $plugins as $plugin => $data ) {
			...
			if ( false == $plugin_data ) {
				...
				if ( isset( $plugin_data['iThemes Package'] ) && 0 < strlen( trim( $plugin_data['iThemes Package'] ) ) ) {
	...
	private function get_theme_hashes() {
		...
		foreach ( $themes as $theme => $data ) {
			...
			if ( false == $theme_data ) {
				...
				if ( isset( $theme_data['iThemes Package'] ) && 0 < strlen( trim( $theme_data['iThemes Package'] ) ) ) {
