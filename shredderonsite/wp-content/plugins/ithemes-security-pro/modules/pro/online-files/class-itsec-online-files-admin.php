...
class ITSEC_Online_Files_Admin {
	...
	public function settings_field_enabled() {
		...
		echo '<p class="description"> ' . __( 'When any WordPress core file has been changed on your system, this feature will compare it with the version on WordPress.org to determine if the change was malicious. Currently this feature only works with WordPress core files (plugins and themes will be added as available).', 'it-l10n-ithemes-security-pro' ) . '</p>';
